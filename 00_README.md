...
| Month 02 | Safety & Adversarial | Red-Teaming: Injection Testing: Refusal Rate Analysis | ⏳ Upcoming |
| Month 03 | Bias & Compliance | Demographic Parity: Fairness Metrics: EU AI Act Audits | ⏳ Upcoming |
...
### Phase 2: Safety & Risk Mitigation
 * I will quantify safety boundaries through Adversarial Red-Teaming and Prompt Injection testing.
 * I will analyze the balance between Under-Refusal (safety risk) and Over-Refusal (utility risk).
### Phase 3: Compliance Auditing
 * I will perform Demographic Parity testing to identify and mitigate algorithmic bias using Pandas.
 * I am translating EU AI Act requirements into technical audit reports and compliance documentation.
